...
- [x] 1. プロジェクトの初期設定
- [x] 1.1 Next.js と TypeScript の環境を構築する
...
- [x] 1.2 package.json のスクリプトとエンジン要件を整備する
...
- [x] 2.2 (P) URLクエリパラメータを解析・バリデーションする機能を実装する
...
- [x] 3. フォントサブセット生成とライセンス対応
- [x] 3.1 Noto Sans JP のサブセット生成スクリプトを作成する
...
- [x] 3.2 サブセットフォントと OFL ライセンスドキュメントをリポジトリに配置する
...
- [x] 10. (P) GitHub Actions CI パイプラインを設定する
